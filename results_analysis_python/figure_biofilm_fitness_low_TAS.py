...
print base_path
input_path = os.path.join(base_path, 'results', 'biofilms', 'preliminary', 'optimal_beta', 'Medium')
output_path = os.path.join(input_path, 'med_NT_AS_fitness_strategy.pdf') #remember to change the end of the file name here!
...
pathsAST = ['NTASANRM50_3day(20160223_1026)', 'NTASA006M50_3day(20160223_1009)', 'NTASA007M50_3day(20160223_1009)', 'NTASA008M50_3day(20160223_1009)', 'NTASADBM50_3day(20160223_1014)']
