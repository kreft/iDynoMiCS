...
print base_path
input_path = os.path.join(base_path, 'results', 'biofilms', 'preliminary', 'optimal_beta', 'High')
output_path = os.path.join(input_path, 'high_T_S_fitness_strategy.pdf') #remember to change the end of the file name here!
...
pathsAST = ['TSANRH50_3day(20160223_1240)', 'TSA006H50_3day(20160223_1224)', 'TSA007H50_3day(20160223_1236)', 'TSA008H50_3day(20160223_1240)', 'TSADBH50_3day(20160223_1238)']
