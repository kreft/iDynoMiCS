...
output_path = os.path.join(input_path, 'figure_4_life_history_Prep_Ptot.pdf')

fig = toolbox_plotting.BmcFigure(double_column=True, height='double')
ms = 2

axisA = fig.add_subplot('A', 211)
...
axisB.set_xlim([0, 0.05])
axisB.set_ylim([0, 0.05])
