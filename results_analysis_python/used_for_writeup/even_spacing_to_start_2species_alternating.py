...
file_path = os.path.join(dir_path, 'agent_State_spacing_alternating_styrofoam.xml')
gridres = 4
density = 201
genealogy = 0.0
generation = 0.0
...
for i in range(16):
    ...
    totalRadius = radius
    locationX = radius
    script += '%i,%i,%i,%i,%f,%f,%f,%f,%f,%i,%i,%f,%f,%f,%f,%f,%i,%i,%i,%f,%s,%i,%i,%i,%i; \n'%(i,genealogy,generation,birthday,activeBiomassG,activeBiomassRepair,inactiveBiomassGrowth,inactiveBiomassRepair,styrofoam,growthRate,volumeRate,locationX,locationY,locationZ,radius,totalRadius,birthX,birthY,birthZ,age,hasDied,deathX,deathY,deathZ,deathday)
script += '</species> \n'
