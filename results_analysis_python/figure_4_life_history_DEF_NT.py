...
#When using this plot, change the label positions in toolbox_plotting to (0, 1.10)
...
output_path = os.path.join(input_path, 'figure_4_life_history_DEF_NT.pdf')
...
paths = ['NT010AS12NR100_agent_State_last.xml', 'NT010S12NR100_agent_State_last.xml']
...
axisA.text(290, 0.60, '3', color=colors[0], fontsize=fs, ha='left', va='top')
axisA.text(290, 0.76, '4', color=colors[0], fontsize=fs, ha='left', va='top')
axisA.text(290, 0.92, '5', color=colors[0], fontsize=fs, ha='left', va='top')
...
setp( axisA.get_xticklabels(), visible=False)
axisA.set_title('Age & Size Distributions', fontsize=9)


axisB = fig.add_subplot('B', 335)
paths = ['NT010AS12007100_agent_State_last.xml', 'NT010S12007100_agent_State_last.xml']
...
axisB.text(285, 0.15, '1', color=colors[1], fontsize=fs, ha='left', va='top')
axisB.text(285, 0.30, '2', color=colors[1], fontsize=fs, ha='left', va='top')
axisB.text(290, 0.37, '3', color=colors[1], fontsize=fs, ha='left', va='top')
axisB.text(292, 0.42, '4', color=colors[1], fontsize=fs, ha='left', va='top')
axisB.text(305, 0.5, '5', color=colors[1], fontsize=fs, ha='left', va='top')
axisB.text(320, 0.6, '6', color=colors[1], fontsize=fs, ha='left', va='top')
...
paths = ['NT010AS12OB100_agent_State_last.xml', 'NT010S12OB100_agent_State_last.xml']
         #, '.xml']
...
axisC.text(280, 0.23, '1', color=colors[4], fontsize=fs, ha='left', va='top')
axisC.text(285, 0.35, '2', color=colors[4], fontsize=fs, ha='left', va='top')
axisC.text(283, 0.47, '3', color=colors[4], fontsize=fs, ha='left', va='top')
axisC.text(295, 0.57, '4', color=colors[4], fontsize=fs, ha='left', va='top')
...
axisC.set_xticks([300, 400, 500, 600])
axisC.set_xlabel('Cellular total biomass (fg)', fontsize=8)
...
fig.subplots_adjust(left=0.09,right=0.99,top=0.96,bottom=0.08,wspace=0.0, hspace=0.2)
