...
/**
 * \brief Extends BacteriumParam for use by BactEPS species, a bacterium with
 * a permanent hydrolytic activity of its EPS capsule.
 * 
...
public class BactEPSParam extends BacteriumParam 
{
	...
	/**
	 * \brief Creates a parameter storage object for the Bacterium EPS species
	 * type.
	 */
	public BactEPSParam()
	{
	...
	/**
	 * \brief Initialises Bacterium EPS Species parameters, calling the
	 * relevant superclasses to initialise common parameters and reading in
													...
													XMLParser speciesDefaults)
	{
		...
		Double temp;
		temp = getSpeciesParameterTime("kHyd", aSpeciesRoot, speciesDefaults);
		kHyd = Double.isFinite(temp) ? temp: kHyd;		
	}
}
